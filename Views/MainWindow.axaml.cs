...
namespace Sharp.Studio.Views
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            assetsView.AddPage(new TabItem() { Header = nameof(AssetsView), Content = new AssetsView() });
            ...
            inspectorView.AddPage(new TabItem() { Header = nameof(InspectorView) , Content = new InspectorView() });
