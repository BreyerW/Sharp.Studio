...
namespace Sharp.Studio
{
    public class Window : IDisposable
    {
        ...
        public string title = "";
        public ImGuiView view;
        public Sdl2Window NativeWindow => _window;
        public Swapchain Swapchain => _sc;

        public Window(GraphicsDevice gd, ImGuiViewportPtr vp)
        {
            _gcHandle = GCHandle.Alloc(this);
            _gd = gd;
            _vp = vp;

            SDL_WindowFlags flags = SDL_WindowFlags.Shown;
        ...
        public Window(GraphicsDevice gd, ImGuiViewportPtr vp, Sdl2Window window)
        {
            _gcHandle = GCHandle.Alloc(this);
            _gd = gd;
            _vp = vp;
